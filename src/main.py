...
def main(**kwargs):
    ...
    if mode['train']:
        ...
        t.test(checkpoint_actor_filename='checkpoint_actor_2018-11-14_00-56.pth',
               checkpoint_critic_filename='checkpoint_critic_2018-11-14_00-56.pth', time_span=1000)
